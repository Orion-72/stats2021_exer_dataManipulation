...
-   List each variable and the level of measurement. Note if there are
    ...
    -   height - continuous, no issues noted
    -   weight - continuous, no issues noted
    -   lvst1 - nominal, no issues noted
    -   lvst2 - nominal, no issues noted
    -   lvst3 - nominal, no issues noted
    -   lvst4 - nominal, no issues noted
    -   frst1 - nominal, no issues noted
    -   frst2 - nominal, no issues noted
    -   frst3 - nominal, no issues noted
...
``` r
#compare the values of fear and love
```
...
-   How do the z-scores compare between the sum scores and the mean
    ...
    -   Answer: most of the z scores are in the negative
...
-   What does it mean if a z-score is positive or negative?
    ...
    -   positive: indicates the raw score is higher than the mean
        average
    -   negative: negative score means it is below the mean
